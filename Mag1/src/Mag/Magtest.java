...
public class Magtest {
	...
	public void  MagnusonTest() throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\deepak.chander\\eclipse1\\Mag1\\exe\\chromedriver.exe");
	...
	Thread.sleep(5000);
	driver.findElement(By.xpath("(//*[@type=\"button\"])[3]"));
	Thread.sleep(5000);
	...
	driver.findElement(By.xpath("//*[@class=\"redbutton btn\"]")).click();
